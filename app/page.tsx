        ...
        <aside className={`flex-col flex-shrink-0 bg-gray-900 border-r border-white/5
          ...
          <div className="px-3 pt-3 pb-2">
            <button
              ...
              className="w-full flex items-center justify-center gap-1.5 px-3 py-2.5 mb-2.5 rounded-xl bg-blue-600 text-white text-xs font-bold hover:bg-blue-500 active:scale-[0.97] transition-all shadow-md"
            >
